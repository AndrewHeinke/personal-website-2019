...
const Portfolio = ({}) => (
  <Layout>
    ...
    <p>
      ...
      Special cloth alert. The other day the grass was brown, now it’s green
    ...
    <p>
      ...
      Take this journey with me, Lion! The key is to drink coconut, fresh
      coconut, trust me. Let me be clear, you have to make it through the jungle
      to make it to paradise, that’s the key, Lion! It’s on you how you want to
      live your life. Everyone has a choice. I pick my choice, squeaky clean.
    </p>
  </Layout>
);
